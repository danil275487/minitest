...
core.register_node("mini_furnaces:furnace", {
	...
	on_break = function(pos)
		local drops = {}
		mini_furnaces.get_inventory_drops(pos, "src", drops)
		mini_furnaces.get_inventory_drops(pos, "fuel", drops)
		mini_furnaces.get_inventory_drops(pos, "dst", drops)
		drops[#drops+1] = "mini_furnaces:furnace"
