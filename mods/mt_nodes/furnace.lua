...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		swap_node(pos, "mt_nodes:furnace_active")
		...
		swap_node(pos, "mt_nodes:furnace")
...
minetest.register_node("mt_nodes:furnace", {
	description =  "Furnace",
	tiles = {
	...
	on_break = function(pos)
		...
		drops[#drops+1] = "mt_nodes:furnace"
