...
local function furnace_node_timer(pos, elapsed)
	...
	if fuel_totaltime ~= 0 then
		...
		swap_node(pos, "mt_nodes:deep_furnace_active")
		...
		swap_node(pos, "mt_nodes:deep_furnace")
...
minetest.register_node("mt_nodes:deep_furnace", {
	...
	on_break = function(pos)
		...
		drops[#drops+1] = "mt_nodes:deep_furnace"
		minetest.remove_node(pos)
		return drops
	end,
})

minetest.register_node("mt_nodes:deep_furnace_active", {
	description =  "Deep Stone Furnace",
	tiles = {
		"mt_atlas.png^[sheet:8x8:0,5", 
		"mt_atlas.png^[sheet:8x8:0,5",
